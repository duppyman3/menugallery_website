...
## Project Purpose
A landing page for that will host a broshure of the app. Also host the privacy and terms of services for google and apples app store.
...
- **Invoke the `frontend-design` skill** before writing any frontend code, every session, no exceptions. And reference the design docs here: /docs/design_concept.json, /docs/design-system.json
